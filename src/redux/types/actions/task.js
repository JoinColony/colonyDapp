...
export type TaskActionTypes = {|
  ...
  TASK_COMMENTS_GET_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_COMMENTS_GET_SUCCESS: ActionType<
    typeof ACTIONS.TASK_COMMENTS_GET_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_CREATE: ActionType<
  ...
  TASK_CREATE_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_CREATE_SUCCESS: ActionType<
    typeof ACTIONS.TASK_CREATE_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_FETCH: ActionType<typeof ACTIONS.TASK_FETCH, {||}, WithKeyPathDepth2>,
  TASK_FETCH_ALL: ActionType<
  ...
  TASK_FETCH_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_FETCH_SUCCESS: ActionType<
    typeof ACTIONS.TASK_FETCH_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_FINALIZE: ActionType<
  ...
  TASK_FINALIZE_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_FINALIZE_SUCCESS: ActionType<
    typeof ACTIONS.TASK_FINALIZE_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_MANAGER_COMPLETE: ActionType<
  ...
  TASK_MANAGER_COMPLETE_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_MANAGER_COMPLETE_SUCCESS: ActionType<
    typeof ACTIONS.TASK_MANAGER_COMPLETE_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_MANAGER_END: ActionType<
  ...
  TASK_MANAGER_END_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_MANAGER_END_SUCCESS: ActionType<
    typeof ACTIONS.TASK_MANAGER_END_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_MANAGER_RATE_WORKER: ActionType<
  ...
  TASK_MANAGER_RATE_WORKER_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_MANAGER_RATE_WORKER_SUCCESS: ActionType<
    typeof ACTIONS.TASK_MANAGER_RATE_WORKER_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_MANAGER_REVEAL_WORKER_RATING: ActionType<
  ...
  TASK_MANAGER_REVEAL_WORKER_RATING_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_MANAGER_REVEAL_WORKER_RATING_SUCCESS: ActionType<
    typeof ACTIONS.TASK_MANAGER_REVEAL_WORKER_RATING_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_MODIFY_WORKER_PAYOUT: ActionType<
  ...
  TASK_MODIFY_WORKER_PAYOUT_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_MODIFY_WORKER_PAYOUT_SUCCESS: ActionType<
    typeof ACTIONS.TASK_MODIFY_WORKER_PAYOUT_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_REMOVE: ActionType<typeof ACTIONS.TASK_REMOVE, {||}, WithKeyPathDepth2>,
  TASK_REMOVE_ERROR: ErrorActionType<
    typeof ACTIONS.TASK_REMOVE_ERROR,
    WithKeyPathDepth2,
  >,
  TASK_REMOVE_SUCCESS: ActionType<
    typeof ACTIONS.TASK_REMOVE_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_SET_DATE: ActionType<
  ...
  TASK_SET_DATE_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_SET_DATE_SUCCESS: ActionType<
    typeof ACTIONS.TASK_SET_DATE_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_SET_SKILL: ActionType<
  ...
  TASK_SET_SKILL_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_SET_SKILL_SUCCESS: ActionType<
    typeof ACTIONS.TASK_SET_SKILL_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_UPDATE: ActionType<typeof ACTIONS.TASK_UPDATE, {||}, WithKeyPathDepth2>,
  TASK_UPDATE_ERROR: ErrorActionType<
    typeof ACTIONS.TASK_UPDATE_ERROR,
    WithKeyPathDepth2,
  >,
  TASK_UPDATE_SUCCESS: ActionType<
    typeof ACTIONS.TASK_UPDATE_SUCCESS,
    *,
    WithKeyPathDepth2,
  >,
  TASK_WORKER_CLAIM_REWARD: ActionType<
  ...
  TASK_WORKER_CLAIM_REWARD_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_WORKER_CLAIM_REWARD_SUCCESS: ActionType<
    typeof ACTIONS.TASK_WORKER_CLAIM_REWARD_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_WORKER_END: ActionType<
  ...
  TASK_WORKER_END_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_WORKER_END_SUCCESS: ActionType<
    typeof ACTIONS.TASK_WORKER_END_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_WORKER_RATE_MANAGER: ActionType<
  ...
  TASK_WORKER_RATE_MANAGER_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_WORKER_RATE_MANAGER_SUCCESS: ActionType<
    typeof ACTIONS.TASK_WORKER_RATE_MANAGER_SUCCESS,
    {||},
    WithKeyPathDepth2,
  >,
  TASK_WORKER_REVEAL_MANAGER_RATING: ActionType<
  ...
  TASK_WORKER_REVEAL_MANAGER_RATING_ERROR: ErrorActionType<
    ...
    WithKeyPathDepth2,
  >,
  TASK_WORKER_REVEAL_MANAGER_RATING_SUCCESS: ActionType<
