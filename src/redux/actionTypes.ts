...
export enum ActionTypes {
  ...
  COLONY_EXTENSION_DEPRECATE= 'COLONY_EXTENSION_UNINSTALL',
  COLONY_EXTENSION_DEPRECATE_ERROR = 'COLONY_EXTENSION_UNINSTALL_ERROR',
  COLONY_EXTENSION_DEPRECATE_SUCCESS = 'COLONY_EXTENSION_UNINSTALL_SUCCESS',
