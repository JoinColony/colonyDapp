...
export enum ActionTypes {
   ...
   * Actions
   *
   * @TODO Refactor to remove the COLONY prefix (we all know these are actions, duh...)
   */
  ...
  /*
   * Metatransaction Actions
   */
  META_MINT_TOKENS = 'META_MINT_TOKENS',
  META_MINT_TOKENS_ERROR = 'META_MINT_TOKENS_ERROR',
  META_MINT_TOKENS_SUCCESS = 'META_MINT_TOKENS_SUCCESS',
  /*
   * Motions
   *
   * @TODO Refactor to remove the COLONY prefix (we all know these are motions, duh...)
   */
   ...
   * MetaTransactions
   */
  METATRANSACTION_CREATED = 'METATRANSACTION_CREATED',
  METATRANSACTION_CANCEL = 'METATRANSACTION_CANCEL',
  /*
   * Wallet
   */
