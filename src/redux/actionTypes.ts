...
export enum ActionTypes {
  ...
  COLONY_EXTENSION_UPLOAD_ADDRESSES = 'COLONY_EXTENSION_UPLOAD_ADDRESSES',
  COLONY_EXTENSION_UPLOAD_ADDRESSES_ERROR = 'COLONY_EXTENSION_UPLOAD_ADDRESSES_ERROR',
  COLONY_EXTENSION_UPLOAD_ADDRESSES_SUCCESS = 'COLONY_EXTENSION_UPLOAD_ADDRESSES_SUCCESS',
  REMOVE_FROM_WHITELIST = 'REMOVE_FROM_WHITELIST',
  REMOVE_FROM_WHITELIST_SUCCESS = 'REMOVE_FROM_WHITELIST_SUCCESS',
  REMOVE_FROM_WHITELIST_ERROR = 'REMOVE_FROM_WHITELIST_ERROR',
  /*
   * Actions
   */
