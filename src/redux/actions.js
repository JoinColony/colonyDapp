...
const ACTIONS = Object.freeze({
  ...
  COLONY_ADMIN_ADD_CONFIRM_ERROR: 'COLONY_ADMIN_ADD_CONFIRM_ERROR',
  COLONY_ADMIN_ADD_CONFIRM_SUCCESS: 'COLONY_ADMIN_ADD_CONFIRM_SUCCESS',
  ...
  COLONY_ADMIN_REMOVE_CONFIRM_ERROR: 'COLONY_ADMIN_REMOVE_CONFIRM_ERROR',
  COLONY_ADMIN_REMOVE_CONFIRM_SUCCESS: 'COLONY_ADMIN_REMOVE_CONFIRM_SUCCESS',
  COLONY_ADMIN_REMOVE_ERROR: 'COLONY_ADMIN_REMOVE_ERROR',
  COLONY_ADMIN_REMOVE_SUCCESS: 'COLONY_ADMIN_REMOVE_SUCCESS',
  COLONY_AVATAR_FETCH: 'COLONY_AVATAR_FETCH',
  COLONY_AVATAR_FETCH_ERROR: 'COLONY_AVATAR_FETCH_ERROR',
  COLONY_AVATAR_FETCH_SUCCESS: 'COLONY_AVATAR_FETCH_SUCCESS',
  ...
  COLONY_ENS_NAME_FETCH: 'COLONY_ENS_NAME_FETCH',
  COLONY_ENS_NAME_FETCH_ERROR: 'COLONY_ENS_NAME_FETCH_ERROR',
  COLONY_ENS_NAME_FETCH_SUCCESS: 'COLONY_ENS_NAME_FETCH_SUCCESS',
  ...
  COLONY_FETCH_TASKS: 'COLONY_FETCH_TASKS',
  COLONY_FETCH_TASKS_ERROR: 'COLONY_FETCH_TASKS_ERROR',
  COLONY_FETCH_TASKS_SUCCESS: 'COLONY_FETCH_TASKS_SUCCESS',
  ...
  CURRENT_USER_CREATE_ERROR: 'CURRENT_USER_CREATE_ERROR',
  CURRENT_USER_CREATE_SUCCESS: 'CURRENT_USER_CREATE_SUCCESS',
  ...
  TASK_COMMENTS_GET: 'TASK_COMMENTS_GET',
  TASK_COMMENTS_GET_ERROR: 'TASK_COMMENTS_GET_ERROR',
  TASK_COMMENTS_GET_SUCCESS: 'TASK_COMMENTS_GET_SUCCESS',
  ...
  TASK_SET_BOUNTY: 'TASK_SET_BOUNTY',
  TASK_SET_BOUNTY_ERROR: 'TASK_SET_BOUNTY_ERROR',
  TASK_SET_BOUNTY_SUCCESS: 'TASK_SET_BOUNTY_SUCCESS',
  TASK_SET_DATE: 'TASK_SET_DATE',
  TASK_SET_DATE_ERROR: 'TASK_SET_DATE_ERROR',
  TASK_SET_DATE_SUCCESS: 'TASK_SET_DATE_SUCCESS',
  TASK_SET_DOMAIN: 'TASK_SET_DOMAIN',
  TASK_SET_DOMAIN_ERROR: 'TASK_SET_DOMAIN_ERROR',
  TASK_SET_DOMAIN_SUCCESS: 'TASK_SET_DATE_SUCCESS',
  ...
  TASK_UNASSIGN_ERROR: 'TASK_UNASSIGN_ERROR',
  TASK_UNASSIGN_SUCCESS: 'TASK_UNASSIGN_SUCCESS',
  ...
  TOKEN_ICON_FETCH: 'TOKEN_ICON_FETCH',
  TOKEN_ICON_FETCH_ERROR: 'TOKEN_ICON_FETCH_ERROR',
  TOKEN_ICON_FETCH_SUCCESS: 'TOKEN_ICON_FETCH_SUCCESS',
  TOKEN_ICON_UPLOAD: 'TOKEN_ICON_UPLOAD',
  TOKEN_ICON_UPLOAD_ERROR: 'TOKEN_ICON_UPLOAD_ERROR',
  TOKEN_ICON_UPLOAD_SUCCESS: 'TOKEN_ICON_UPLOAD_SUCCESS',
  ...
  USER_AVATAR_FETCH: 'USER_AVATAR_FETCH',
  USER_AVATAR_FETCH_ERROR: 'USER_AVATAR_FETCH_ERROR',
  USER_AVATAR_FETCH_SUCCESS: 'USER_AVATAR_FETCH_SUCCESS',
  ...
  USER_TASK_IDS_FETCH: 'USER_TASK_IDS_FETCH', // TODO: rename
  USER_TASK_IDS_FETCH_ERROR: 'USER_TASK_IDS_FETCH_ERROR',
  USER_TASK_IDS_FETCH_SUCCESS: 'USER_TASK_IDS_FETCH_SUCCESS',
  ...
  USER_REMOVE_AVATAR_ERROR: 'USER_REMOVE_AVATAR_ERRROR',
  USER_REMOVE_AVATAR_SUCCESS: 'USER_REMOVE_AVATAR_SUCCESS',
  USER_UPLOAD_AVATAR: 'USER_UPLOAD_AVATAR',
  USER_UPLOAD_AVATAR_ERROR: 'USER_UPLOAD_AVATAR_ERRROR',
  ...
  USERNAME_FETCH_ERROR: 'USERNAME_FETCH_ERROR',
  USERNAME_FETCH_SUCCESS: 'USERNAME_FETCH_SUCCESS',
