...
export const CURRENT_USER_GET_BALANCE = `${ns}/CURRENT_USER_GET_BALANCE`;
export const CURRENT_USER_GET_BALANCE_SUCCESS = `${ns}/CURRENT_USER_GET_BALANCE_SUCCESS`;
export const CURRENT_USER_GET_BALANCE_ERROR = `${ns}/CURRENT_USER_GET_BALANCE_ERROR`;
