...
const MSG = defineMessages({
  ...
  endpointsDesc: {
    ...
    defaultMessage: 'Specify your own endpoints for interacting with 3rd party services.',
  },
  labelMetaTx: {
  ...
  tooltip: {
    ...
    defaultMessage: `Metatransactions are turned on by default. If you would rather connect directly to xDai chain, and pay for your own transactions, you can turn them off by switching the toggle at any time.
    Please note, this setting is stored locally in your browser, if you clear your cache you will need to turn Metatransactions off again.`,
  },
});
  ...
  return (
    ...
    >
      {({ status, isSubmitting }) => (
        <div className={styles.main}>
         <Heading
          ...
          <div className={stylesAdvance.toggleContainer}>
            <Toggle label={MSG.labelMetaTx} labelValues={{ isOn: false }} name="metatransactions" />
            <QuestionMarkTooltip
          ...
          <div className={stylesAdvance.metaDesc}><FormattedMessage
            {...MSG.metaDesc}
          /></div>
          <Heading
            appearance={{ theme: 'dark', size: 'medium' }}
        ...
        />
          <div className={stylesAdvance.endpointsDesc}><FormattedMessage
            {...MSG.endpointsDesc}
          /></div>
