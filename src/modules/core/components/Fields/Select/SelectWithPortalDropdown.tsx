...
import { DOWN, ENTER, ESC, SPACE, UP } from '~types/index';
...
SelectWithPortalDropdown.displayName = displayName;

SelectWithPortalDropdown.defaultProps = {
  appearance: { alignOptions: 'left', theme: 'default' } as Appearance,
  options: [],
};

export default SelectWithPortalDropdown;
