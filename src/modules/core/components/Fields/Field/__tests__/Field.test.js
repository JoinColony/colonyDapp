...
describe('Field component standalone', () => {
  test('Renders initial component', () => {
    const wrapper = shallowWithIntl(<Field name="test" standalone component={TestFieldComponent} />);
  ...
  test('Uses the id provided if specified', () => {
    const wrapper = shallowWithIntl(<Field name="test" id="cool" standalone component={TestFieldComponent} />);
    expect(wrapper).toHaveProp('id', 'cool');
  });

  test('Passes props to field wrapper', () => {
    const wrapper = shallowWithIntl(<Field className="className" name="test" data-foo="bar" standalone component={TestFieldComponent} />);
  ...
  test('Throws when using it without a rendered label and without an id', () => {
    expect(() => {
      shallowWithIntl(<Field name="test" standalone component={TestFieldComponent} elementOnly />);
    }).toThrow();
  });

  test('Assembles labels properly', () => {
    const wrapperStringLabel = shallowWithIntl(<Field name="test" elementOnly label="Test" standalone component={TestFieldComponent} />);
...
describe('Field component embedded in redux-form', () => {
  ...
  test('Contains a ReduxFormField', () => {
    const wrapper = mountWithIntl(<Field name="test" label="Test" component={TestFieldComponent} />, reduxFormContext);
