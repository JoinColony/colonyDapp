...
import { Appearance as IAppearance } from '../Fields/InputLabel/InputLabel';
...
const UserPickerWithSearch = ({
  ...
  const labelAppearance: IAppearance = appearance
    ? { direction: appearance.direction, colorSchema: 'lightGrey' }
