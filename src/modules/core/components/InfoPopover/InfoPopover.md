...
### InfoPopover on an user's avatar

Simply requires `showInfo`, and the `user` to be passed onto the `UserAvatar` component.
...
### InfoPopover with an incorrect address provided
