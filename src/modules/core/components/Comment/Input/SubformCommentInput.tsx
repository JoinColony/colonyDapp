...
const displayName = 'core.Comment.SubformCommentInput';

const MSG = defineMessages({
  commentInputPlaceholder: {
    id: 'core.Comment.SubformCommentInput.commentInputPlaceholder',
    defaultMessage: 'What would you like to say?',
  },
  commentInstuctions: {
    id: 'core.Comment.SubformCommentInput.commentInstuctions',
    defaultMessage: `{sendCombo} to send {newLineCombo} for a new line`,
  },
  newLineCombo: {
    id: 'core.Comment.SubformCommentInput.newLineCombo',
    defaultMessage: 'Shift+Return',
  },
  sendCombo: {
    id: 'core.Comment.SubformCommentInput.sendCombo',
...
SubformCommentInput.displayName = displayName;

export default SubformCommentInput;
