...
export default function* ipfsSagas(): Saga<void> {
  yield takeEvery(ACTIONS.IPFS_DATA_UPLOAD, ipfsUploadSaga);
  yield takeEvery(ACTIONS.IPFS_DATA_FETCH, ipfsFetchSaga);
}
