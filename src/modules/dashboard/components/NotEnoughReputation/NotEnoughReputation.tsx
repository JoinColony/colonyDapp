...
const MSG = defineMessage({
  ...
  description: {
    ...
    defaultMessage: `Reputation is generated by making payments to members with this colony’s native token. If you have the necessary permissions to take this action you can toggle “Force” in the top right to bypass the governance process. {Learn more}(https://colony.gitbook.io/colony/key-concepts/reputation).`,
  },
});
