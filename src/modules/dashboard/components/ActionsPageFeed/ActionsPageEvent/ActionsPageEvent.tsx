...
const ActionsPageEvent = ({
  ...
  /*
   * @TODO This needs to be refactor to have less boilerplate code
   *
  ...
  const [autogeneratedIds] = useState<Record<string, string[]>>({
    [ColonyAndExtensionsEvents.OneTxPaymentMade]: [
      ...new Array(ROLES_MAP[ColonyAndExtensionsEvents.OneTxPaymentMade]),
    ].map(() => nanoid()),
    [ColonyAndExtensionsEvents.Generic]: [
      ...new Array(ROLES_MAP[ColonyAndExtensionsEvents.Generic]),
    ].map(() => nanoid()),
  });
  return (
