...
import ContractHttpLoader from '@colony/colony-js/colony-js-contract-loader-http';
import EthersAdapter from '@colony/colony-js/colony-js-adapter-ethers';
import ColonyNetworkClient from '@colony/colonyNetwork/colony-js-client';
