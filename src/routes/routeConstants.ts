...
export const COLONY_DECISIONS_PREVIEW_ROUTE = `${COLONY_HOME_ROUTE}/decisions/preview`;
...
export const DECISIONS_PAGE_ROUTE = `${COLONY_HOME_ROUTE}/decisions/tx/:transactionHash`;
