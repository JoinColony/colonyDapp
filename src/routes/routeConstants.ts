...
export const COLONY_EXPENDITURE_ROUTE = `${COLONY_HOME_ROUTE}/expenditure`;
export const COLONY_INCORPORATION_ROUTE = `${COLONY_HOME_ROUTE}/incorporation`;
...
export const VERIFICATION_ROUTE = `${COLONY_INCORPORATION_ROUTE}/verification`;
