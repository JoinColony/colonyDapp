 ...
 */
class WhitelistAccessController implements AccessController {
  ...
  constructor(accountAddress: string, purserWallet: PurserWallet) {
    if (!accountAddress) {
      throw new Error('Could not get account address. Is it unlocked?');
    }
