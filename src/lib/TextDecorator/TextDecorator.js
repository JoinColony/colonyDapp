...
export default class TextDecorator {
  ...
  constructor(validDecorators: Object = {}) {
  ...
  _processMatch(match: Object, decorators: Object) {
    const decoratorName =
  ...
  _decorate(text: string, decorators: Object = {}): Array<string> {
  ...
  _Decorate({ children, tagName = 'span', decorators, ...props }: *) {
