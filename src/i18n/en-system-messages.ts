...
const systemMessagesMessageDescriptors = {
  'systemMessage.title': `{name, select,
      ...
      ${SystemMessagesName.MotionCanBeEscalated} {{escalateTag} period started. {spaceBreak}{spaceBreak} If you believe this result was unfair, and would be different if more people we involved, you may escalate it to a higher domain.}
