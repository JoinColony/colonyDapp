...
import MaskedAddress from '~components/core/MaskedAddress';
import GroupList from '~components/core/GroupList';
import Dialog, { DialogSection } from '~components/core/Dialog';

import { currentUserAddressSelector } from '~redux/selectors';
  ...
  render() {
    ...
    const listItems = [
      ...
      },
      {
        ...
        imageUrl:
          // TODO: Figure out if we'll make this one of our icons
